<nav class="navbar navbar-expand-lg navbar-light bg-white shadow " id="nav">
	...
	<a class="navbar-brand mr-auto" href="<?php echo base_url() ?>">
		<h2 class="text-success" style="font-family: poppins;"><?php echo SITE_NAME ?></h2>
	</a>
	...
	<form class="form-inline mx-auto form col-md-4 col-12  ml-md-5" action="<?php echo site_url('produk/search') ?>" method="post">
		...
		<input class="form-control form-control-sm searchform col-10" type="search" placeholder="Search" name="keyword" value="<?php if (isset($keyword_search)) {
																																																															echo $keyword_search;
																																																														} ?>">
